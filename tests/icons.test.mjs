...
test('cache includes all declared icons and only removes this project old caches', async () => {
  ...
  vm.runInNewContext(worker, {
    ...
    caches: { keys: async () => ['screenshot-trimmer-v11', 'screenshot-trimmer-v12', 'screenshot-trimmer-v13', 'subflow-v9'], delete: async key => deleted.push(key) }
  });
  let finished;
  handlers.activate({ waitUntil(promise) { finished = promise; } });
  await finished;
  assert.deepEqual(deleted, ['screenshot-trimmer-v11', 'screenshot-trimmer-v12']);
